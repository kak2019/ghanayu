...
const getSummaries = () => { 
  // 底部合计行   
  const lastLatestMonthQty = "100";
  const currentMonthDefectsQty =  "200";
  const currentMonthCompletionQty =   "300"
  const currentMonthShippingQty =   "400"
  const curentMonthStockQty =  "500"
